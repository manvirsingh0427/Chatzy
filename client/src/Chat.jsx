...
export default function Chat() {
  ...
  return (
    <div className="flex h-screen dark:bg-gray-900 dark:text-white">
      <div className="bg-white dark:bg-gray-800 w-1/3 flex flex-col">
        ...
        <div className="p-2 text-center flex items-center justify-center">
          ...
          <button
            onClick={logout}
            className="text-sm bg-blue-100 dark:bg-gray-700 py-1 px-2 text-gray-500 dark:text-gray-200 border rounded-sm">logout</button>
        </div>
      </div>
      <div className="flex flex-col bg-blue-50 dark:bg-gray-800 w-2/3 p-2">
        <div className="flex-grow">
          {!selectedUserId && (
            <div className="flex h-full flex-grow items-center justify-center">
              <div className="text-gray-300 dark:text-gray-500">&larr; Select a person from the sidebar</div>
            </div>
          )}
          {!!selectedUserId && (
        ...
        {!!selectedUserId && (
          <form className="flex gap-2" onSubmit={sendMessage}>
            ...
            <button type="submit" className="bg-blue-500 dark:bg-blue-600 p-2 text-white rounded-sm">
